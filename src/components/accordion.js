...
export default function AccordionComponent() {
  return (
    <Accordion allowZeroExpanded>
      <h1 className="text-center text-4xl font-mono py-2">FAQs</h1>
      <AccordionItem className="my-8 bg-tendoGreen text-white">
        <AccordionItemHeading>
          <AccordionItemButton>
...
//                           />
//                         </svg>
//                         <h4 className="text-md text-gray-900 dark:text-gray-400">
