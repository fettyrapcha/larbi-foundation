...
const Land = () => {
    return (
        <div className="h-[38rem]">
            ...
            <section class="h-[38rem] mb-32 text-gray-800 text-center lg:text-left background-radial-gradient ">

                <div class="relative overflow-hidden bg-no-repeat bg-cover mm" s>
                    <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bb">
                        <div class="flex justify-center items-center h-full">
                            <div class="text-center text-white px-6 py-6 md:py-0 md:px-12 max-w-[800px]">
                                <h2 class="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight leading-tight mb-12">
                                    Making life <br /><span>easy for them</span>
                                </h2>
                                <p class="text-lg">
